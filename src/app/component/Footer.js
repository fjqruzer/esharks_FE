      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
           <img src="/logo-white.png" alt="LSB Sharks Unlimited" className="w-25 mr-2" />
            <p className="text-gray-400 text-sm mb-6">
                 LSB Sharks Unlimited. First in-campus esports organization in Zambales, Olongapo. Lyceum of Subic Bay.
            </p>
            <p className="text-gray-400 text-sm">© 2025 LSB Sharks Unlimited. All rights reserved.</p>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-4"></h3>
